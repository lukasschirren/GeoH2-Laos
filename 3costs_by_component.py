...
# Load hexagons
hexagons = gpd.read_file(f'Resources/Scenario_{hydro_year}_{electrolyser_type}_{scenario_year}/hex_total_cost.geojson')
...
stores_csv_path = f'Parameters_{electrolyser_type}_{scenario_year}/Basic_H2_plant/stores.csv' # H2 storage
stores_parameters = pd.read_csv(stores_csv_path, index_col='name')
storage_csv_path = f'Parameters_{electrolyser_type}_{scenario_year}/Basic_H2_plant/storage_units.csv' # Battery
storage_parameters = pd.read_csv(storage_csv_path, index_col='name')
links_csv_path = f'Parameters_{electrolyser_type}_{scenario_year}/Basic_H2_plant/links.csv' # Electrolyzer
links_parameters = pd.read_csv(links_csv_path, index_col='name')
generators_csv_path = f'Parameters_{electrolyser_type}_{scenario_year}/Basic_H2_plant/generators.csv' # Solar and wind
...
hexagons.to_file(f'Resources/Scenario_{hydro_year}_{electrolyser_type}_{scenario_year}/hex_cost_components.geojson', driver='GeoJSON', encoding='utf-8')
hexagons.to_csv(f'Resources/Scenario_{hydro_year}_{electrolyser_type}_{scenario_year}/hex_cost_components.csv', encoding='latin-1')
